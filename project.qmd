...
The proposal document for the project, which outlines the information needs for the database as well as the main entities, is linked here: [Nintendo SQL Database Proposal Document](pdf/INFO330AProject-Grp2-Proposal%20(1)).

The Excel database that I manually created to represent the various Nintendo games is linked here: [Nintendo SQL Excel Database](pdf/Nintendo_Database.xlsx).
