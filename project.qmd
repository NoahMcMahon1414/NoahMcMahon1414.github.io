...
The final project file that includes a summary of the database as well as all of the user queries and their respective results is right here: [Nintendo SQL Database Final Project Summary](pdf/INFO_330_Final_Project%20(1).pdf).
