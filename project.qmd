...
The proposal document for the project, which outlines the information needs for the database as well as the main entities, is linked here: [Nintendo SQL Database Proposal Document](pdf/INFO330AProject-Grp2-Proposal (1)).
